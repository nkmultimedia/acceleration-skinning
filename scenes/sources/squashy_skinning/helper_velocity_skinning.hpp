...
struct joint_speed {
    ...
    vcl::vec3 linear_acceleration;
    vcl::vec3 angular_speed_drag;
    vcl::vec3 angular_speed_squash;
    vcl::vec3 angular_acceleration_squash;
    vcl::vec3 angular_acceleration_followThrough;
    vcl::vec3 angular_speed_stretch;
};
