...
struct speed_tracker
{
    ...
    float alpha_speed_drag = 0.75f;
    float alpha_acceleration = 0.75f;
};
...
struct rotation_tracker
{
    ...
    vec3 avg_rotation_speed_drag;
    vec3 last_rotation_speed_drag;
    vec3 avg_rotation_speed_squash;
    vec3 last_rotation_speed_squash;
    vec3 avg_rotation_speed_followThrough;
    vec3 last_rotation_speed_followThrough;
    vec3 avg_rotation_speed_stretch;
    vec3 last_rotation_speed_stretch;
    //quaternion avg_rotation_acceleration;
    vec3 avg_angular_acceleration_squash;
    vec3 avg_angular_acceleration_followThrough;

    // temporal filter new_speed = alpha*old_speed + (1-alpha)*current_speed
    static float alpha_speed_drag;
    static float alpha_speed_squash;
    static float alpha_acceleration_squash;
    //static float alpha_speed_followThrough;
    static float alpha_acceleration_followThrough;
    static float alpha_speed_stretch;
    //float alpha_acceleration = 0.75f;
};
